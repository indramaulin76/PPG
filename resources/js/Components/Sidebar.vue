...
<template>
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white/80 backdrop-blur-xl border-r border-gray-200 shadow-sm hidden lg:flex flex-col">
        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <div class="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-2 mt-6 px-3">Wilayah</div>
            
            <Link :href="route('wilayah.desa.index')" :class="{'bg-blue-50 text-blue-600': isActive('wilayah.desa'), 'text-gray-600 hover:bg-gray-50': !isActive('wilayah.desa')}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors group">
            ...
            <Link :href="route('wilayah.kelompok.index')" :class="{'bg-blue-50 text-blue-600': isActive('wilayah.kelompok'), 'text-gray-600 hover:bg-gray-50': !isActive('wilayah.kelompok')}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-colors group">
            ...
            <a href="/laporan" class="flex items-center px-3 py-2.5 text-sm font-medium text-gray-600 rounded-lg hover:bg-gray-50 transition-colors group">
        ...
        <div class="p-4 border-t border-gray-100">
            <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center text-white font-bold text-xs">A</div>
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-medium text-gray-900 truncate">Admin</p>
                    <p class="text-xs text-gray-500 truncate">admin@simj.com</p>
                </div>
            </div>
        </div>
    </aside>
