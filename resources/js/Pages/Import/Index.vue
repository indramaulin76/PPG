    ...
    <AppLayout title="Import Data Jamaah">
        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white rounded-2xl shadow-sm p-8">
                <div class="mb-8">
                    <h2 class="text-xl font-semibold text-gray-900 mb-2">Upload File CSV</h2>
                    <p class="text-gray-600">Upload file CSV berisi data jamaah untuk diimport ke dalam sistem.</p>
                </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
                    <div class="flex items-start space-x-3">
                        ...
                        <div>
                            <h3 class="font-semibold text-blue-900 mb-1">Format File CSV</h3>
                            <p class="text-sm text-blue-700 mb-3">Pastikan file CSV memiliki kolom-kolom berikut:</p>
                            <code class="block bg-blue-100 text-blue-800 text-xs px-3 py-2 rounded font-mono">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                            ...
                            <div class="space-y-1 text-center">
                                ...
                                <div class="flex text-sm text-gray-600">
                                    <label for="file-upload" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none">
                                        ...
                                        <input id="file-upload" name="file" type="file" class="sr-only" accept=".csv" @change="form.file = $event.target.files[0]" />
                                    </label>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <div class="space-x-3">
                            <button type="button" @click="downloadTemplate" class="px-6 py-2.5 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 font-medium transition-colors">
                                Download Template
                            </button>
                ...
                <div v-if="$page.props.errors.file" class="mt-6 bg-red-50 border border-red-200 rounded-xl p-4">
                    <div class="flex items-center">
                        <svg class="w-5 h-5 text-red-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                        <p class="text-red-900 font-medium">{{ $page.props.errors.file }}</p>
                    </div>
                </div>
            </div>
        </div>
