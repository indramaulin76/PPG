...
// Admin Desa cares about Total Kelompok in their Desa
const statCards = [
...
// Access user info to display Desa name if needed
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6 lg:col-span-2">
                    <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">Sebaran Usia (Lingkup Desa)</h3>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900">Jamaah Terbaru (Desa)</h3>
