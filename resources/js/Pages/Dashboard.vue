        ...
        <div class="space-y-6">
                    ...
                    <dt>
                        <div class="absolute rounded-md p-3 bg-gradient-to-br" :class="stat.color">
                            <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <path v-else stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" />
                            </svg>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-2xl shadow-sm p-6 lg:col-span-2">
                    <h3 class="text-lg font-medium leading-6 text-gray-900 mb-4">Sebaran Usia Jamaah</h3>
            ...
            <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                    <h3 class="text-lg font-medium text-gray-900">Data Terbaru</h3>
